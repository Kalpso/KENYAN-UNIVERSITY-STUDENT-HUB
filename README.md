!-- Kenyan Student Hub - Single File HTML Version (Frontend + LocalStorage Backend) -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
...
<style>
  ...
  .card { background:white; padding:20px; margin-top:20px; border-radius:10px; box-shadow:0 2px 5px rgba(0,0,0,0.1); animation:fade 0.4s; }
...
<!-- LOGIN -->
<div class="card page" id="login" style="display:none;">
  <h2>Login</h2>
